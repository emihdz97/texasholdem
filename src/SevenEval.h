...
public:
  ...
  //extern "C" uint16_t GetRank(uint8_t, uint8_t, uint8_t, uint8_t,
...
/*
extern "C" uint16_t call_GetRank(SevenEval* program, uint8_t i, uint8_t j, uint8_t k, uint8_t m,
      uint8_t n, uint8_t p, uint8_t q) // wrapper function
    {
        return program->GetRank(i,j,k,m,n,p,q);
    }*/
