...
{ 
    ...
    /*
    Basicamente tienen todas las cartas en el "deck" para acceder a ellas es por posicion y por rank ("Ace", "Two", "Three", "Four", "Five", "Six", "Seven", 
			  "Eight", "Nine", "Ten", "Jack", "Queen", "King") o por el suit ("Clubs", "Diamonds", "Hearts", "Spades")
    para acceder a ellos la estructura es "deck[int].rank/.face"
    el jugador es un poco mas complicado...
    es una esctructura que contiene varios datos los que a ustedes les interesan son "score", "card1_pos" y "card2_pos" basicamente los card_pos guardan una posicion del el arreglo deck
    correspondientes a las 2 cartas de cada jugador
    para acceder a esos la estructura es "players_Data[int"hay 3 clientes del 0 al 2"].card1_pos/.card2_pos/.score"
    las cartas correspondientes a las cartas abiertas estan el las posiciones del deck (6, 7, 8, 9, 10)
    y nesecito que guarden el valor corespondiente a cada jugador e su score correspondiente
    */
